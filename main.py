...
class Settings(BaseSettings):
    database_url: str = "postgresql://gioiellino_admin:LnRlKuDdE6FGiN3fuWi0L1uWhYC7Oqep@dpg-cup2amaj1k6c739f45p0-a.frankfurt-postgres.render.com/gioiello_db"
    api_key: str = "6fb9923350bef0e66e7f17d0420511e7"
